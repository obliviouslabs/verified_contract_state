...
use reth_revm::primitives::{keccak256, Address, B256, FixedBytes};
...
pub async fn restore_contract_memory_uncertain<T: EthApiClient<Transaction, Block, Receipt> + Send + Sync>(
    provider: Arc<T>,
    contract_address: Address,
    block_number: BlockId,
