...
pub fn add_static_array_addresses(_name: &str, addresses: &mut HashSet<B256>, slot: B256, size: u64) {
...
// #[allow(dead_code)]
pub fn add_dynamic_array_addresses(_name: &str, addresses: &mut HashSet<B256>, slot: B256, max_size: u64) {
  let slot = U256::from_be_bytes(slot.0);
  {
      addresses.insert(B256::from(slot));
  }
...
pub fn add_mapping_addresses<'a, T: Iterator<Item = &'a B256>> (_name: &str, addresses: &mut HashSet<B256>, slot: B256, access_keys: T) {
  {
...
pub fn add_2d_mapping_addresses<'a, T: Iterator<Item = &'a (B256, B256)>>(_name: &str, addresses: &mut HashSet<B256>, slot: B256, access_keys: T) {
  {
      addresses.insert(slot);
  }
